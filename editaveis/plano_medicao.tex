\section{Time de medição (Time GQM)}
	...
	\subsubsection{Questão Q3}
		...
		% Esta questão será respondida por meio da comparação da métrica M5 com a M6, gerando a métrica M7 e M8, sendo que
		% por meio de análise feita pela equipe responsável pelo GQM, dado o aspecto subjetivo da questão, será conhecido
		% se o time está melhor entendendo a linguagem.
