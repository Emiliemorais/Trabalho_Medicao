...
\section{Time de medição (Time GQM)}
    ...
    \section{Procedimentos}
      ...
      \subsection{Análise dos dados}
      	...
      	Nesta subseção serão descritos os procedimentos para a análise dos dados coletados,
      	de forma a responder às questões definidas.
      	...
      	\subsubsection{Questão Q1}
      		...
      		pontos definida pela métrica M4.Média de pontos alocados por \textit{sprint}, e utilizando o valor da métrica M2.Média de
      		pontos realizados por dia para a
      		queima dos pontos durante a \textit{sprint}, simulando o começo do trabalho no início da \textit{sprint}.
